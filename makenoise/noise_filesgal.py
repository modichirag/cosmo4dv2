...
for M0 in mms:
    ...
    #mbinsm = np.linspace(np.log10(M0)-1, min(10, np.log10(M0) + 4), 10)[::-1]
...
#
    ...
    ff = mtpath + 'noisehist_M%02d_gal.png'%(10*np.log10(M0))
    ...
    fpath = mtpath + 'hist_M%02d_gal.txt'%(10*np.log10(M0))
