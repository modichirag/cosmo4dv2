...
if masswt: ofolder = mainfolder + '/v2/z%02d/L%04d_N%04d_S%04d/biasmass-n%02d/'%(zz, bs, nc, seed, numd*1e4)
...
#if masswt: fname = 's%03d_mass%s'%(iseed, prefix)
#else: fname = 's%03d_pos%s'%(iseed, prefix)
